...
version = "0.0.1"
application {
    mainClass.set("dev.synapsetech.teampages.ApplicationKt")
...
dependencies {
    ...
    implementation("org.litote.kmongo:kmongo-serialization:4.6.1") // MongoDB
    implementation("xyz.downgoon:snowflake:1.0.0") // ID generation
    implementation("org.jetbrains.kotlinx:kotlinx-serialization-json:1.4.0") // JSON
